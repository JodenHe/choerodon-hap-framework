...
public class XMap extends HashMap<Object, Object> implements Cloneable {
     ...
     * XMap 中属性值类型
     **/
    public static String XML_DATA_TYPE_FUNCTION = "fn:";
    public static String XML_DATA_TYPE_BOOLEAN = "boolean:";
    public static String XML_DATA_TYPE_INTEGER = "integer:";
    public static String XML_DATA_TYPE_LONG = "long:";
    public static String XML_DATA_TYPE_FLOAT = "float:";
    public static String XML_DATA_TYPE_DOUBLE = "double:";
    public static String XML_DATA_TYPE_DATE = "date:";
    ...
    public Object getPropertity(String key){
        ...
        if(StringUtils.startsWith(value, XML_DATA_TYPE_FUNCTION)) {
            return new ReferenceType(StringUtils.substringAfter(value, XML_DATA_TYPE_FUNCTION));
        } else if(StringUtils.startsWith(value, XML_DATA_TYPE_BOOLEAN)) {
            return new Boolean(StringUtils.substringAfter(value, XML_DATA_TYPE_BOOLEAN));
        } else if(StringUtils.startsWith(value, XML_DATA_TYPE_INTEGER)) {
            return new Integer(StringUtils.substringAfter(value, XML_DATA_TYPE_INTEGER));
        } else if(StringUtils.startsWith(value, XML_DATA_TYPE_LONG)) {
            return new Long(StringUtils.substringAfter(value, XML_DATA_TYPE_LONG));
        } else if(StringUtils.startsWith(value, XML_DATA_TYPE_FLOAT)) {
            return new Float(StringUtils.substringAfter(value, XML_DATA_TYPE_FLOAT));
        } else if(StringUtils.startsWith(value, XML_DATA_TYPE_DOUBLE)) {
            return new Double(StringUtils.substringAfter(value, XML_DATA_TYPE_DOUBLE));
        } else if(StringUtils.startsWith(value, XML_DATA_TYPE_DATE)) {
            SimpleDateFormat sb = new SimpleDateFormat("yyyy-MM-dd");
            try {
                return sb.parse(StringUtils.substringAfter(value, XML_DATA_TYPE_DATE));
    ...
    public void putPropertity(Object key, Object value){
        if(value instanceof ReferenceType) {
            value =  XML_DATA_TYPE_FUNCTION + ((ReferenceType)value).getReference();
        } else if(value instanceof Integer) {
            value =  XML_DATA_TYPE_INTEGER + value.toString();
        } else if(value instanceof Double) {
            value =  XML_DATA_TYPE_DOUBLE + value.toString();
        } else if(value instanceof Float) {
            value =  XML_DATA_TYPE_FLOAT + value.toString();
        } else if(value instanceof Long) {
            value =  XML_DATA_TYPE_LONG + value.toString();
        } else if(value instanceof Boolean) {
            Boolean v = (Boolean) value;
            value =  XML_DATA_TYPE_BOOLEAN + (v ? "true" : "false");
        }  else if(value instanceof Date) {
            value =  XML_DATA_TYPE_DATE + DateFormatUtils.format((Date)value, "yyyy-MM-dd");
        } 
        put(key, value);
    }
