...
import io.choerodon.hap.core.web.view.XMapHandler;
import io.choerodon.hap.core.web.view.XMapParser;
import io.choerodon.hap.core.web.view.XMapUtil;
...
public class ScreenView extends DefaultFreeMarkerView {
    private static final Logger logger = LoggerFactory.getLogger(ScreenView.class);
