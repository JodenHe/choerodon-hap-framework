...
function assigneeRenderer({ record, text }) {
  if (record.get('assigneeName')) {
    return [
      `${record.get('assigneeName')}(${text})`,
    ];
  }
  return '';
}
...
export default class Index extends PureComponent {
  taskResponseExtDS = new DataSet(TaskResponseExtDS);
    ...
    return (
      <Content>
        ...
        >
          ...
          <Column name="assignee" renderer={assigneeRenderer} />
