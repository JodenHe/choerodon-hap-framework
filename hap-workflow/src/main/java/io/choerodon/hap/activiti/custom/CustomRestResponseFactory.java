package io.choerodon.hap.activiti.custom;

import io.choerodon.hap.activiti.custom.process.HistoricProcessInstanceEntityImpl;
import io.choerodon.hap.activiti.dto.DeploymentResponseExt;
 ...
 */
@Component(value = "restResponseFactory")
