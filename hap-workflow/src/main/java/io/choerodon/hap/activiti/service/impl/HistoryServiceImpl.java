...
import io.choerodon.hap.activiti.service.HistoryService;
...
@Service
@Dataset("History")
public class HistoryServiceImpl implements IDatasetService<HistoricProcessInstanceQueryRequest>, HistoryService {
    ...
    public List<?> queries(Map<String, Object> body, int page, int pageSize, String sortname, boolean isDesc) {
        try {
            ...
            requestParams.put("involved", "true");
