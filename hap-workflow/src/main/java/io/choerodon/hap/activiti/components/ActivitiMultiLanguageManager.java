...
import io.choerodon.fnd.util.dto.Prompt;
import io.choerodon.fnd.util.service.IPromptService;
...
public class ActivitiMultiLanguageManager implements InitializingBean {
    ...
    private static IPromptService promptService;
    ...
    public static String getMultiLanguageInfoByDescription(String description, IRequest iRequest) {
        if (StringUtils.isNotEmpty(description)) {
            ...
            List<Prompt> prompts = promptService.selectOptions(prompt, criteria);
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        promptService = applicationContext.getBean(IPromptService.class);
    }
}
