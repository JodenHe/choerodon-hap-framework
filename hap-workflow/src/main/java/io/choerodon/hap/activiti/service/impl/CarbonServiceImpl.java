...
import io.choerodon.hap.activiti.service.CarbonService;
...
@Service
@Dataset("Carbon")
public class CarbonServiceImpl implements IDatasetService<HistoricProcessInstanceQueryRequest>, CarbonService {
    ...
    public List<?> queries(Map<String, Object> body, int page, int pageSize, String sortname, boolean isDesc) {
        try {
            ...
            if (sortname == null) {
                historicProcessInstanceQueryRequest.setSort("readFlag");
                historicProcessInstanceQueryRequest.setOrder("asc");
            } else {
            ...
            requestParams.put("carbonCopy", "true");
