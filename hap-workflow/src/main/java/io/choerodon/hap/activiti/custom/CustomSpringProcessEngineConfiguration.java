...
import io.choerodon.hap.activiti.custom.process.CustomHistoryService;
import io.choerodon.hap.activiti.custom.task.CustomTaskService;
...
public class CustomSpringProcessEngineConfiguration extends SpringProcessEngineConfiguration {
    ...
    public InputStream getMyBatisXmlConfigurationStream() {
        return getResourceAsStream("io/choerodon/hap/activiti/custom/mappings.xml");
    }
