...
databaseChangeLog(logicalFilePath: 'script/db/iam_menu.groovy') {
    ...
    changeSet(author: 'qiang.zeng', id: '2019-05-13-menu-add-default-value') {
        dropColumn(tableName: 'IAM_MENU_B', columnName: 'RESOURCE_LEVEL')
        addColumn(tableName: 'IAM_MENU_B') {
            column(name: 'RESOURCE_LEVEL', type: 'VARCHAR(64)', afterColumn: 'NAME', remarks: '菜单层级', defaultValue: 'site') {
                constraints(nullable: false)
            }
        }
    }
