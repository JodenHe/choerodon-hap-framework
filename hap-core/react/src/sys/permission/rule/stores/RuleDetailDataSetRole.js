...
export default {
  ...
  fields: [
    ...
    { name: 'permissionFieldValue', type: 'string', bind: 'permissionField.roleId', label: $l('datapermissionruledetail.permissionfieldvalue') },
    { name: 'permissionFieldName', type: 'string', bind: 'permissionField.roleName', label: $l('datapermissionruledetail.permissionfieldvalue') },
