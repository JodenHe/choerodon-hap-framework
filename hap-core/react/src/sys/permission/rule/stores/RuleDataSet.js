...
export default {
  ...
  fields: [
    ...
    { name: 'ruleCode', type: 'string', label: $l('datapermissionrule.rulecode'), unique: true },
    { name: 'ruleName', type: 'string', label: $l('datapermissionrule.rulename'), required: true },
    { name: 'permissionField', type: 'string', label: $l('datapermissionrule.permissionfield'), lookupCode: 'SYS.AUTHORITY_SEGMENT' },
  ],
  queryFields: [
